<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="events.aspx.cs" Inherits="EOTCYU_HTX.Presentation_Layer.events" %>
...
<head runat="server">
	...
	<title>www.EOTCYU.org | Events </title>
      ...
      <div class="container">
        ...
        <nav>
          <ul>
			...
			<li  class="current"><a href="events.aspx">Events</a></li>
